...
.eFlY5su5n_qQKxEoylrc {
  ...
  align-items: center;
}`, "",{"version":3,"sources":["webpack://./src/components/CreateBookmark/CreateBookmark.module.scss"],"names":[],"mappings":"AAAA;EACI,kBAAA;EACA,aAAA;EACA,8BAAA;EACA,aAAA;EACA,wBAAA;EACA,gBAAA;AACJ;AAAI;EACC,gBAAA;EACA,aAAA;EACA,mBAAA;AAEL;AAAI;EACI,aAAA;EACA,6BAAA;EACA,mBAAA;AAER;AAAI;EACI,cAAA;EACA,gBAAA;EACA,sCAAA;AAER;AAAI;EACI,aAAA;EACA,cAAA;EACA,sBAAA;EACA,kCAAA;EACA,sBAAA;EACA,gBAAA;AAER;;AAEA;EACI,kBAAA;EACA,uBAAA;EACA,eAAA;AACJ;;AAEA;EACI,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AACJ","sourcesContent":[".form {\n    align-self: center;\n    display: grid;\n    grid-template-columns: 1fr 2fr;\n    gap: 1.25vmin;\n    color: var(--text-light);\n    min-height: 8rem;;\n    label{\n     font-size: 2vmin;\n     display: flex;\n     align-items: center;    \n    }\n    div {\n        display: flex;\n        justify-content: space-around;\n        align-items: center;\n    }\n    input {\n        padding: 1vmin;\n        font-size: 2vmin;\n        border: .1vmin solid var(--text-dark);\n    }\n    .button {\n        margin: 1vmin;\n        padding: 1vmin;\n        color: var(--offwhite);\n        background-color: var(--text-dark);\n        border-radius: .5vmin;\n        min-height: 4rem;\n    }\n}\n\nh2 {\n    text-align: center;\n    color: var(--text-dark);\n    font-size: 2rem;\n}\n\n.container {\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
body {
  ...
  justify-content: center;
  align-items: center;
}`, "",{"version":3,"sources":["webpack://./src/styles.module.scss"],"names":[],"mappings":"AAAA;EACI,mBAAA;EACA,qBAAA;EACA,oBAAA;EACA,qBAAA;AACJ;;AAGA;EACI,SAAA;EACA,YAAA;EACA,aAAA;EACA,iCAAA;EACA,wBAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;AAAJ","sourcesContent":[":root{\n    --offwhite: #fdfcf1;\n    --text-light: #968c84;\n    --text-dark: #615954;\n    --text-black: #161616;\n}\n\n\nbody {\n    margin: 0;\n    padding: 1vw;\n    height: 100vh;\n    background-color: var(--offwhite);\n    color: var(--text-black);\n    display: flex;\n    flex-direction: column;\n    justify-content: center;\n    align-items: center;\n}"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/******/ })()
;
//# sourceMappingURL=App.5735fa1b8ea8ede035814591bd8a8a6d.js.map